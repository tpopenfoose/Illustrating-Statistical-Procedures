...
s3d <- scatterplot3d(DF[,c(2,3,1)], type="p", highlight.3d=TRUE,
...
bplot(Predict(lininterp, x1=25:40, x2=45:60), lfun = contourplot)
bplot(Predict(lininterp, x1=25:40, x2=45:60), lfun = levelplot)