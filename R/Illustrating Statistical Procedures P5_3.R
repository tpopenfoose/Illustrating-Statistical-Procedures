...
# from the psych, plotrix, lattice, TeachingDemos and symbols packages.
...
# install.packages(c("psych", "plotrix", "lattice", "TeachingDemos", "symbols"), dependencies = TRUE)
...
# The pairs.panels() function in the psych package adds a 
# histogram and a correlation (see Procedure 6.1)
